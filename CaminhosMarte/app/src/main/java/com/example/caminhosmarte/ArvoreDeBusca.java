...
//
//        while (atual != null) {
//            if (atual.info.compareTo((NoArvore<Dado>) procurado) == 0) // atual aponta o nó com o registro procurado, antecessor aponta seu "pai"
//                return true;
//
//            antecessor = atual;
//            if (procurado.compareTo((NoArvore<Dado>) atual.info) < 0)
...
//            return false;
//
//        if (local.info.compareTo((NoArvore<Dado>) procurado) == 0) {
//            atual = local;
//            return true;
//        }
//
//        antecessor = local;
//        if (procurado.compareTo((NoArvore<Dado>) local.info) < 0)
...
//            if (dadoLido.compareTo((NoArvore<Dado>) antecessor.info) < 0)
...
//            while (!achou && !fim) {
//                antecessor = atual;
//                if (novosDados.compareTo((NoArvore<Dado>)atual.info) < 0) {
//                    atual = atual.esq;
//                    if (atual == null) {
//                        antecessor.esq = novoNo;
//                        fim = true;
//                    }
//                } else if (novosDados.compareTo((NoArvore<Dado>)atual.info) == 0)
...
//                if (novoRegistro.compareTo((NoArvore<Dado>) antecessor.info) < 0)  // novo é menor que antecessor
...
//        while (atual.info.compareTo((NoArvore<Dado>)registroARemover) != 0)  // enqto não acha a chave a remover
//        {
//            antecessor = atual;
//            if (atual.info.compareTo((NoArvore<Dado>)registroARemover) > 0) {
